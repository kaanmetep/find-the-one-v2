        ...
        <div className=" shadow-2xl flex flex-col gap-12 rounded-md">
          <div className="p-4">
            ...
            <p className=" text-center mt-2">
              ...
              mollitia natus numquam quos non libero? Nihil itaque error
              repellat debitis ipsum animi vitae cum corrupti rem odio aliquam
              quos unde numquam officia incidunt, consectetur ratione. Cumque
              voluptates harum neque corrupti aut laborum quis.
            </p>
          </div>
          <div className="h-24 bg-rose-200 relative  rounded-t-full  flex items-center justify-center mt-auto">
            ...
            />
            <p className="mt-12 text-slate-600 italic font-bold">
              Elizabeth P.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col shadow-2xl gap-12 border-2 border-rose-200 rounded-md">
          <div className="p-4">
            ...
            <p className="text-center mt-2">
              ...
              sequi corrupti eius fugiat dolorem soluta nesciunt aperiam iusto
              ipsa repellendus expedita vitae asperiores facere tenetur
              architecto sunt non, cupiditate, dolores delectus quibusdam
              explicabo possimus voluptatem autem. Iure consectetur omnis
              suscipit! Perspiciatis magnam quis nihil rem explicabo dolorum
              minus inventore vel!
            </p>
          </div>
        ...
        <div className="flex flex-col shadow-xl gap-12 rounded-md">
          <div className="p-4">
            ...
            <p className="text-center mt-2">
              ...
              exercitationem similique dignissimos totam et vero, aperiam ex,
              ipsa quo accusamus amet. Aliquid.
            </p>
          </div>
